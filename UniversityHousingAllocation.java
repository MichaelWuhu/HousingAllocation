...
public class UniversityHousingAllocation {
    public static void main(String[] args) {
        ...
        while (distanceFromCampusInMiles <= 0) { // Catches user input that is below 0 miles
            System.out.print("Invalid input. How far are you from campus? Enter in miles: "); // Prompts user an integer
                                                                                              // value for
                                                                                              // distanceFromCampusInMiles
        ...
        while (firstComeFirstServe < 0) { // Catches user input that is below 0 days
            System.out.print(
                    "Invalid input. Enter days since the release of this form (First Come First Serve policy): "); // Prompts
                                                                                                                   // user
                                                                                                                   // an
                                                                                                                   // integer
                                                                                                                   // value
        ...
        System.out.print("Are you an incoming student? Enter \"true\" or \"false\": "); // Prompts user an integer value
                                                                                        // for incoming student
        boolean incomingStudent = sc.nextBoolean();
        System.out.println(); // Creates new line to ask next question
        ...
        while (numberOfChildren < 0) { // Catches user input that is below 0
            System.out.print("Invalid input. Enter number of children: "); // Prompts user an integer value for
                                                                           // numberOfChildren
            numberOfChildren = sc.nextInt();
            System.out.println(); // Creates new line to ask next question
        }

        System.out.print("Enter Unweighted GPA (Highschool GPA if Freshman): "); // Prompts user a double value for
                                                                                 // studentGPA
        ...
        while (studentGPA < 0.0 || studentGPA > 4.0) { // Catches user input that is below 0.0 or above 4.0
            System.out.print("Invalid input. Enter Unweighted GPA (Highschool GPA if Freshman): "); // Prompts user an
                                                                                                    // integer value for
                                                                                                    // studentGPA
        ...
        int score = calculateHousingScore(distanceFromCampusInMiles, haveOnCampusJob, haveFinancialNeed,
                haveDisabilities, firstComeFirstServe, incomingStudent, numberOfChildren, studentGPA);
        // Initialize an integer "score" and set it equal to the method below with all
        ...
        if (score > 0 && score <= 12) {
            ...
            System.out.println("You have middle priority."); // Prints middle priority if student has score from 13 to
                                                             // 24
        } else {
            System.out.println("You have high priority."); // Prints highest priority if student has score from 25 to 36
    ...
    public static int calculateHousingScore(int distanceFromCampusInMiles, boolean haveOnCampusJob,
            boolean haveFinancialNeed, boolean haveDisabilities, int firstComeFirstServe, boolean incomingStudent,
            int numberOfChildren, double studentGPA) {

        // Initialize score
        int score = 0;

        // conditionals to check how many points to add to score based off of student's
        ...
        // adds points based on how early the student form was filled out (User input is
        // based on firstComeFirstServe)
        if (firstComeFirstServe >= 1 && firstComeFirstServe <= 10) {
            ...
            score += 1;
            // Add 1 point if the user filled out the form within the first 3 months.
            // Anything more does not get any points.
        }
